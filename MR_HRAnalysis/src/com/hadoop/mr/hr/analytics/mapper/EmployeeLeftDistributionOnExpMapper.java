...
public class EmployeeLeftDistributionOnExpMapper extends Mapper<Object, Text, Text, HRResourceWritable>{
	...
	protected void map(Object key, Text value, Context context)
		...
		IntWritable exp = new IntWritable(Integer.parseInt(splits[4].trim()));
		...
		hrResourceWritable.setExperience(exp);
