...
public class UsersAndRatingsJoinerMapper extends Mapper<Object, Text, Text, MovieDetailsTextWritable>{
	...
	protected void map(Object key, Text value, Context context) throws IOException, InterruptedException {
		...
		if (fileName.contains(MovieLensUtils.FILE_MOVIES)) {
			...
			movieDetails.setGenres(new Text(genres));
			movieDetails.setIsValid(new BooleanWritable(isValid));
