...
object KPI2_NoOfMedalsByCountries {
  ...
  def main(args: Array[String]) = {
    ...
    if (args.length > 1) {
      System.err.print("Usages: KPI2_NoOfMedalsByCountries <inputFilePath>")
      System.exit(1)
    }

    //Creating spark session
    val sparkSession = SparkSession.builder().appName("KPI2_NoOfMedalsByCountries").getOrCreate()
    ...
    sparkSession.sql("select country, sum(countTotalMedals) from olympic_data group by country").show()
...
//bin/spark-submit --class com.spark.oda.KPI2_NoOfMedalsByCountries /home/barun/SparkWorkshopArtifacts/OlympicData/olympicDataAnalyserJob.jar /home/barun/SparkWorkshopArtifacts/OlympicData/olympic_Data.csv