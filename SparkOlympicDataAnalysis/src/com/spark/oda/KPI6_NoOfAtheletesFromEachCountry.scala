...
object KPI6_NoOfAtheletesFromEachCountry {
  ...
  def main(args: Array[String]) = {
    ...
    sparkSession.sql("select country, year, sport, sum(countTotalMedals) from olympic_data group by country, year, sport having sum(countTotalMedals) = 1").show()
...
//bin/spark-submit --class com.spark.oda.KPI6_NoOfAtheletesFromEachCountry /home/barun/SparkWorkshopArtifacts/OlympicData/olympicDataAnalyserJob.jar /home/barun/SparkWorkshopArtifacts/OlympicData/olympic_Data.csv