...
object KPI1_NoOfAthleteInEachEvent {
  ...
  def main(args: Array[String]) = {
    ...
    if (args.length > 1) {
      System.err.print("Usages: KPI1_NoOfAthleteInEachEvent <inputFilePath>")
      System.exit(1)
    }

    //Creating spark session
    val sparkSession = SparkSession.builder().appName("KPI1_NoOfAthleteInEachEvent").getOrCreate()
    ...
    //No of athletes participated in each Olympic event
    sparkSession.sql("select sport, count(distinct(athlete)) from olympic_data group by sport").show()
...
//bin/spark-submit --class com.spark.oda.KPI1_NoOfAthleteInEachEvent /home/barun/SparkWorkshopArtifacts/OlympicData/olympicDataAnalyserJob.jar /home/barun/SparkWorkshopArtifacts/OlympicData/olympic_Data.csv /home/barun/SparkWorkshopArtifacts/OlympicData/KPI1_NoOfAthleteInEachEvent-out-001